...
servidor.registerTool("multiplicar", { title: "Herramienta de multiplicar numeros",
...
//recurso dinamico
servidor.registerResource("saludar", new ResourceTemplate("saludar://{nombre}", { list: undefined }), { title: "Recurso para saludar", description: "Pidele un saludo" }, async (url, { nombre }) => {
